...
class CrewAgentOutputParser(ReActSingleInputOutputParser):
    ...
    def parse(self, text: str) -> Union[AgentAction, AgentFinish, CacheHit]:
        ...
        Returns:
        - Union[AgentAction, AgentFinish, CacheHit]: Returns an instance of AgentAction, AgentFinish, or CacheHit based on the parsed information.

        Raises:
        - TaskRepeatedUsageException: If the tool usage is repeated.
        """
